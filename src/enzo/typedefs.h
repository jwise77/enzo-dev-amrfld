...
/* these pseudo-fields are used to access grid data 
  ...
  gParticlePosition     = 47,
  gParticleVelocity     = 48,
  gParticleMass         = 49,
  gParticleAcceleration = 50,
  gParticleNumber       = 51,
  gParticleType         = 52,
  gParticleAttribute    = 53,
  gPotentialField       = 54,
  gAccelerationField    = 55,
  gGravitatingMassField = 56,
  gFlaggingField        = 57,
  gVelocity             = 58,
  ...
  AccelerationField1    = 68, 
  AccelerationField2    = 69, 
  AccelerationField3    = 70,

  Galaxy1Colour          = 71,
  Galaxy2Colour          = 72,
/* these are required for Sam Skillman's Shock/Cosmic ray models. */
  Mach            = 73,
  PreShockTemperature = 74,
  PreShockDensity = 75,  
