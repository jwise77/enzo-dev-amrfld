  ...
  do k=1,Nz,1
     do j=1,Ny,1
        do i=1,Nx,1
           ...
           kap = 2.d0*nUn*kappa(i,j,k)*kappa(i,j,k-1) &
                / (kappa(i,j,k)+kappa(i,j,k-1))
           kap0 = kap/nUn*nUn0
           ...
           !    compute average opacity over face
           kap = 2.d0*nUn*(kappa(i,j,k)*kappa(i,j-1,k)) &
                / (kappa(i,j,k)+kappa(i,j-1,k))
           kap0 = kap/nUn*nUn0
           ...
           !    compute average opacity over face
           kap = 2.d0*nUn*(kappa(i,j,k)*kappa(i-1,j,k)) &
                / (kappa(i,j,k)+kappa(i-1,j,k))
           kap0 = kap/nUn*nUn0
...
!=======================================================================
  ...
  do j=1,Ny,1
     do i=1,Nx,1
        ...
        !    compute average opacity over face
        kap = 2.d0*nUn*(kappa(i,j)*kappa(i,j-1)) &
             / (kappa(i,j)+kappa(i,j-1))
        kap0 = kap/nUn*nUn0
        ...
        !    compute average opacity over face
        kap = 2.d0*nUn*(kappa(i,j)*kappa(i-1,j)) &
             / (kappa(i,j)+kappa(i-1,j))
        kap0 = kap/nUn*nUn0
...
!=======================================================================
  ...
  do i=1,Nx,1
     ...
     !    compute average opacity over face
     kap = 2.d0*nUn*(kappa(i)*kappa(i-1))/(kappa(i)+kappa(i-1))
     kap0 = kap/nUn*nUn0
