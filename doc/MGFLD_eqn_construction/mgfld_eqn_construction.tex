...
\begin{itemize}
\item {\em AMRFLDMultifrequency} -- Boolean flag denoting whether to
  use the multi-frequency solver (1) or the multi-group solver (0).
  Default: 0
...
\item {\em AMRFLDFrequencies[:]} -- floating-point values for each
  frequency, $\nu_i$.  For the multi-frequency solver the user must
