...
\end{align}
where we have defined the multi-group emissivity $\eta_{\omega}, \omega=1,\ldots,N_f-1$ and
multi-group opacity $\kappa_{\omega}, \omega=1,\ldots,N_f-1$ above in the equations
...
\begin{align}
  ...
  &\partial_{\tT} \tE - \frac{\Tunit}{\Lunit^2}\tnabla\cdot\(D_{\omega}\,\tnabla \tE_{\omega}\)
